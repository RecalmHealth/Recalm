...
<div class="dropdown">
<button class="btn btn-outline-secondary dropdown-toggle rounded-pill px-4 text-capitalize" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="border-color: #6c757d;">
...
{
label: 'Senang',
data: [25].concat(@json($senangData).map(c => Math.min(25 + (c * 4), 30))), 
borderColor: '#1E4F91',
...
{
label: 'Marah',
data: [15].concat(@json($marahData).map(c => Math.min(15 + (c * 4), 20))), 
borderColor: '#E69500',
